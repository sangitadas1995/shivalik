            ...
            <div class="sidebar-content">
                ...
                <nav class="menu open-current-submenu hover-clone-div">
                    <ul>
                        <li
                            ...
                            <div class="sub-menu-list">
                                <ul>
                                    ...
                                    <li
                                        class="menu-item {{ Route::is('printing-vendor', 'vendors.printing.edit') ? 'active' : null }}">
                                        <a href="{{ route('printing-vendor') }}">
                                            <span class="menu-title">Printing vendor</span>
                                        </a>
                                    </li>
                                    <li
                                        class="menu-item {{ Route::is('paper-vendor', 'vendors.paper.edit') ? 'active' : null }}">
                        ...
                        <li
                            class="menu-item {{ Route::is('papertype.index', 'papertype.add', 'papertype.edit') ? 'active' : null }}">
                        ...
                        <li data-bs-toggle="collapse"
                            ...
                            <div class="sub-menu-list" data-bs-toggle="collapse" data-popper-escaped=""
                                ...
                                <ul>
                                        ...
                                        <div class="sub-menu-list" data-bs-toggle="collapse" data-popper-escaped=""
                                            ...
                                            <ul>
                                                <li
                                                    ...
                                                    <a
                                                        href="{{ route('settings.papersettings.paper_category_list') }}">
                                                ...
                                                <li
                                                    ...
                                                    <a
                                                        href="{{ route('settings.papersettings.paper_quality_list') }}">
                                                ...
                                                <li
                                                    ...
                                                    <a
                                                        href="{{ route('settings.papersettings.paper_thickness_list') }}">
                                                ...
                                                <li
                                                    ...
                                                    <a
                                                        href="{{ route('settings.papersettings.quantity-calculation') }}">
                                    ...
                                    <li
                                        class="menu-item sub-menu {{ Route::is('settings.payment-terms-condition', 'settings.payment-mode-list') ? 'open active' : null }}">
                                        ...
                                        <div class="sub-menu-list" data-bs-toggle="collapse" data-popper-escaped=""
                                            ...
                                            <ul>
                                                <li
                                                    class="menu-item {{ Route::is('settings.payment-terms-condition') ? 'active' : null }}">
                                                    <a href="{{ route('settings.payment-terms-condition') }}">
                                                        <span class="menu-title">Payment Terms & Condition
                                                            Settings</span>
                                                    </a>
                                                </li>
                                                <li
                                    ...
                                    <li
                                        class="menu-item sub-menu {{ Route::is('settings.upload-file-type-list', 'settings.edit-po-file-type', 'settings.add-po-file-type') ? 'open active' : null }}">
                                        <a><span class="menu-title">PO File Type Settings</span></a>
                                        <div class="sub-menu-list" data-bs-toggle="collapse" data-popper-escaped=""
                                            data-popper-placement="right"
                                            style="left: 0px; top: 0px; margin-right: 0px; margin-left: 0px; box-sizing: border-box; display: none;">
                                            <ul>
                                                <li
                                                    class="menu-item {{ Route::is('settings.upload-file-type-list', 'settings.edit-po-file-type', 'settings.add-po-file-type') ? 'active' : null }}">
                                                    <a href="{{ route('settings.upload-file-type-list') }}">
                                                        <span class="menu-title">PO File Type List</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li
                                        class="menu-item sub-menu {{ Route::is('settings.order.product.index') ? 'open active' : null }}">
                                        <a><span class="menu-title">Order Settings</span></a>
                                        <div class="sub-menu-list" data-bs-toggle="collapse" data-popper-escaped=""
                                            data-popper-placement="right"
                                            style="left: 0px; top: 0px; margin-right: 0px; margin-left: 0px; box-sizing: border-box; display: none;">
                                            <ul>
                                                <li
                                                    class="menu-item {{ Route::is('settings.order.product.index') ? 'active' : null }}">
                                                    <a href="{{ route('settings.order.product.index') }}">
                                    ...
                                    <li class="menu-item {{ Route::is('settings.edit-profile') ? 'active' : null }}">
                                    ...
                                    <li
                                        class="menu-item {{ Route::is('settings.admin-terms-settings') ? 'active' : null }}">
                                        <a href="{{ route('settings.admin-terms-settings') }}">
                                            <span class="menu-title">Admin Terms & Condition Settings</span>
                                        </a>
                                    </li>

                                    <li
                                        class="menu-item {{ Route::is('settings.po-facilitation-settings') ? 'active' : null }}">
