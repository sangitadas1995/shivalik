    ...
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-md-6">
        <div class="text-end mb-4">
          <a href="{{ route('settings.papersettings.add_paper_color') }}" class="btn primary-btn"
    ...
    <script>
      $(document).ready(function () {
        ...
        let papercolor_list_table = $('#papercolor_list_table').DataTable({
          ...
          pageLength: 10,
          ajax: {
            url: "{{ route('settings.papersettings.colorlistdata') }}",
            type: 'POST',
            'data': function(data) {
              return data;
            }
        ...
        if (rowid) {
          Swal.fire({
            ...
            if (result.isConfirmed) {
              $.ajax({
                type: "post",
                url: "{{ route('settings.papersettings.doupdatestatuspapercolor') }}",
                data: {
                  rowid,
                  rowstatus
                },
