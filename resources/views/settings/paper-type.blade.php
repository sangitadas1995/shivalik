    ...
    <div class="row justify-content-between align-items-center">
        ...
        <!-- <div class="col-md-6">
            <div class="text-end mb-4">
                <a href="./setting-add-printing-products-type.html" class="btn primary-btn"><svg
    ...
    <div class="card-body">
        <form>
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Paper Category :</label>
            ...
            <div class="setting-paper-type-table mb-4">



                <!-- head -->

                <div class="grid grid-cols-5 head">
                    <div class=" colum-border">
                ...
                <!-- rows -->
                <div class="grid grid-cols-5 paper-type-row">
                    <div class=" colum-border">
                        <div class=" colum">
                    ...
                    <div class=" colum-border content-center">
                        <div class="colum ">
                            <p>Brightness</p>
                        </div>
                    </div>
