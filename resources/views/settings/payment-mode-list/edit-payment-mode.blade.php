...
<div class="page-name">
   <div class="row justify-content-between align-items-center">
      <div class="col-md-4">
         <h2>
            <a href="{{ route('settings.payment-mode-list') }}"><i class="ri-arrow-left-line"></i></a> Edit Payment Mode
         </h2>
      </div>
   </div>
</div>
<div class="card add-new-location mt-2">
    <div class="card-body">
        <form action="{{ route('settings.update-payment-mode', encrypt($payment_mode->id)) }}" method="POST" id ="admin-payment-settings-form">
            @csrf
            <div class="row">
                <div class="col-md-12">
                @include('utils.alert')
