...
<div class="page-name">
    <div class="row justify-content-between align-items-center">
        <div class="col-md-4">
            <h2><i class="ri-arrow-left-line"></i> Printing Product Type</h2>
        </div>
        <div class="col-md-6">
            <div class="text-end mb-4">
                <button type="button" onclick="addTypeFormOpen(event)" id="addTypeFormOpenBtn" href="#"
                    class="btn primary-btn"><svg width="24" height="24" viewBox="0 0 30 30" fill="none"
...
<div class="card  mt-2">
    <div class="card-body">
        <form action="" class="add-paper-type-form add-type-form d-none">
            <div class="row">
                <div>
                    <div class="mb-3">
                        <label class="form-label">Printing Product Type :</label>
                        ...
                        <a href="#" title="Edit">
                            <svg width="29" height="29" viewBox="0 0 29 29" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#4A88DA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path
...
@section('scripts')
<script>
    function addTypeFormOpen(event) {
        let addTypeForm = document.querySelector('.add-type-form');
        if (addTypeForm.classList.contains('d-none')) {
            addTypeForm.classList.remove('d-none');
            document.getElementById('addTypeFormOpenBtn').classList.add('d-none')
        } else {
            addTypeForm.classList.add('d-none')
            document.getElementById('addTypeFormOpenBtn').classList.remove('d-none')
        }
    }
</script>
<script>
