...
<div class="page-name">
  <div class="row justify-content-between align-items-center">
    <div class="col-md-4">
      <h2>
        <a href="{{ route('settings.upload-file-type-list') }}"><i class="ri-arrow-left-line"></i></a> Add Payment Mode
      </h2>
    </div>
  </div>
</div>
<div class="card add-new-location mt-2">
  <div class="card-body">
    <form action="{{ route('settings.store-payment-method') }}" method="POST" id="papercolor-add-form">
      @csrf
      <div class="row">
        <div class="col-md-12">
          @include('utils.alert')
