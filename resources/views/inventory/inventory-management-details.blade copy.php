                ...
                <div class="sidebar-layout">
                    ...
                    <div class="sidebar-content">
                        <div class="ul-box mb-3">
                            <ul class="row">
                                <li>
                                    <a href="#"><span class="w-100"><img src="images/mi_user.png" /> <br />User
                                            Management</span></a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="w-100"><img src="images/customer.png" /> <br />
                                            Customer</span></a>
                                </li>
                                <li>
                                    <a href="#"><span class="w-100"><img src="images/order-approve-outline-sharp.png" />
                                            <br />
                                            Order Management</span></a>
                                </li>
                                <li>
                                    <a href="#"><span class="w-100"><img src="images/ic_round-inventory.png" /><br />
                                    ...
                                    <a href="#">
                                        <span class="menu-icon">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                ...
                                                <path
                                                    d="M3.19201 17.3336H4.11451V18.309C4.11451 19.4779 4.68601 19.9879 5.79338 19.9879H15.2066C16.3226 19.9879 16.8851 19.4779 16.8851 18.309V17.3336H17.817C19.5221 17.3336 20.427 16.4723 20.427 14.7585V6.53177C20.427 4.82665 19.5221 3.95665 17.817 3.95665H16.947V3.4909C16.947 1.77715 16.0943 1.01215 14.4596 1.01215H6.54001C5.00213 1.01215 4.05301 1.77715 4.05301 3.4909V3.95665H3.19201C1.56601 3.95665 0.572632 4.82665 0.572632 6.53177V14.7585C0.572632 16.4723 1.47788 17.3336 3.19201 17.3336ZM5.41576 3.39415C5.41576 2.65577 5.79338 2.2954 6.52313 2.2954H14.4769C15.2156 2.2954 15.5846 2.65577 15.5846 3.39415V3.95665H5.41501L5.41576 3.39415ZM3.17401 16.0151C2.39176 16.0151 1.98751 15.6019 1.98751 14.8286V6.46165C1.98751 5.68802 2.39176 5.27477 3.17401 5.27477H17.8343C18.6075 5.27477 19.0118 5.68802 19.0118 6.46127V14.8286C19.0118 15.6023 18.6075 16.0151 17.8343 16.0151H16.8848V10.7419C16.8848 9.57265 16.3223 9.06302 15.2063 9.06302H5.79338C4.73888 9.06302 4.11488 9.57302 4.11488 10.7419V16.0151H3.17401ZM6.23251 18.6694C5.76676 18.6694 5.52938 18.4406 5.52938 17.9576V11.0846C5.52938 10.6099 5.76676 10.3901 6.23251 10.3901H14.7754C15.2501 10.3901 15.4699 10.6099 15.4699 11.0846V17.9576C15.4699 18.441 15.2501 18.6694 14.7754 18.6694H6.23251ZM7.45426 13.5544H13.5626C13.8791 13.5544 14.1075 13.317 14.1075 13.0005C14.1075 12.7016 13.8788 12.4733 13.5626 12.4733H7.45388C7.13776 12.4733 6.90038 12.702 6.90038 13.0005C6.90038 13.317 7.13776 13.5544 7.45426 13.5544ZM7.45426 16.6219H13.5626C13.8791 16.6219 14.1075 16.3841 14.1075 16.0856C14.1075 15.7781 13.8788 15.5404 13.5626 15.5404H7.45388C7.13776 15.5404 6.90038 15.7778 6.90038 16.0853C6.90038 16.3841 7.13776 16.6219 7.45426 16.6219Z"
                                                    fill="#BEC9D9" />
                                            </svg>
                                        ...
                                        <span class="menu-icon">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#BEC9D9" stroke-width="2" stroke-linecap="round"
            ...
            <div class="layout">
                <header class="header">
                    ...
                    <div class="dropdown navbar-nav-right profile-img-text">
                        <a class="dropdown-toggle align-items-center" class="btn btn-secondary dropdown-toggle"
                            type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="d-flex">
                                <span><img class="img-xs rounded-circle" src="images/face15.jpg" alt="" /></span>
                ...
                <main class="content bg-lightGray">
                    <div class="page-name">
