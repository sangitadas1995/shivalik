...
<div class="card add-new-location mt-2">
  <div class="card-body">
    <form action="{{ route('papersettings.storepapersize') }}" method="POST" id="papersize-add-form">
      @csrf
      <div class="row">
        <div class="col-md-12">
          @include('utils.alert')
        ...
        <div class="col-md-12">
          <div class="mb-3">
            ...
            <input type="text" class="form-control alphaChar" name="size_name" id="name" value="{{ old('size_name') }}"/>
