...
<div class="page-name">
  <div class="row justify-content-between align-items-center">
    <div class="col-md-4">
      <h2>
        <a href="{{ route('customers.index') }}"><i class="ri-arrow-left-line"></i></a> Edit Customer
      </h2>
    </div>
  </div>
</div>
    ...
    <form action="{{ route('customers.update', ['id' => encrypt($customer->id)]) }}" method="POST" id="customer-edit-form">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="contact_person_designation" id="contact_person_designation"
              value="{{ $customer->contact_person_designation }}" />
          ...
          <div class=" row">
            <div class="col-md-6">
              <div class="mb-3  d-flex flex-column">
                ...
                <input type="text" id="mobile_code-1" class="form-control mobileNumber" name="mobile_no"
            ...
            <div class="col-md-6">
              <div class="mb-3 d-flex flex-column">
                <label class="form-label">Alternative Mobile No.
                  :</label>
                <input type="text" id="mobile_code-2" class="form-control mobileNumber" name="alter_mobile_no"
                  value="{{  $customer->alter_mobile_no }}" />
            ...
            <div class="col-md-6">
              <div class="mb-3 d-flex flex-column">
                ...
                <input type="text" id="alternative_email_id" class="form-control" name="alternative_email_id"
                  value="{{  $customer->alternative_email_id }}" />
          ...
          <div class=" row">
            <div class="col-md-6">
              <div class="mb-3  d-flex flex-column">
                ...
                <input type="text" id="mobile_code-3" class="form-control onlyNumber phoneNumber" name="phone_no"
            ...
            <div class="col-md-6">
              <div class="mb-3 d-flex flex-column">
                ...
                <input type="text" id="mobile_code-4" class="form-control onlyNumber phoneNumber"
                  name="alternative_phone_no" value="{{  $customer->alternative_phone_no }}" />
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="customer_website" id="customer_website"
              value="{{  $customer->customer_website }}" />
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="country" name="country_id">
              ...
              <option value="{{ $country->id }}" {{ $country->id == $customer->country_id ? 'selected' : null }}>{{
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="state" name="state_id">
              ...
              <option value="{{ $state->id }}" {{ $state->id == $customer->state_id ? 'selected' : null }}>{{
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="city" name="city_id">
              ...
              <option value="{{ $city->id }}" {{ $city->id == $customer->city_id ? 'selected' : null }}>{{
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control onlyNumber" name="print_margin" id="print_margin"
              value="{{  $customer->print_margin }}" />
      ...
      <div class="text-end">
        <a href="{{ route('customers.index') }}"><button type="button"
            class="btn grey-primary reset_edit_customer">Cancel</button></a>
