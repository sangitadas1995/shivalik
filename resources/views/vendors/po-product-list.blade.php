                ...
                <div class="child-table">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="table-responsive table-sec mb-4 paper-vendor-modal-table">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                <input type="checkbox" name="paper_id[]" class="paper_id" data-id="{{ $paper['paper_id'] }}" value="{{ $paper['paper_id'] }}"></td>
                                ...
                                @if (isset($paper_list) && count($paper_list) > 0)
                                <div class="text-end">
                                <button type="submit" class="btn black-btn product_assign_to_po" style="float:right;margin-left: 9px;">Add</button>
                                </div>
                                @endif
                        </div>
                    </div>
