    ...
    <div class="popup-content" style="width:90%;">
        ...
        <button class="close-popup-btn" data-bs-dismiss="modal" aria-label="Close">
            <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.01562 0.984375L0.984375 8.01562M0.984375 0.984375L8.01562 8.01562" stroke="#18202B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </button>
        <div class="container">
        ...
        <div class="child-table">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="order_status_title"></div>
                        ...
                        <div class="border-block">
                            ...
                            <div class="tholder max-w-540" id="showPoAmtDetails"></div>
                        </div>
                        
                        <div class="border-block no-border">
                            <div class="big-title">Download 
                                <i class="fa fa-download" aria-hidden="true"></i> &nbsp;&nbsp;<a href="JavaScript:void(0);" class="text-primary po_file_list_view" data-id="{{$vendorPoDetails->id}}" title="Upload Related Documents"><i class="fa fa-upload" style="font-size:20px;"></i></a> 
                            </div>
                            <ul class="auto-ul" id="showPoUploadDocList">
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3">
