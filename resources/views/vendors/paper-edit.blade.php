            ...
            <div class="col-md-6">
              <div class="mb-3 d-flex flex-column">
                ...
                <input type="text" id="alternative_email_id" class="form-control" name="alternative_email_id"
                  value="{{ $paper->alternative_email_id }}" />
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="state" name="state_id">
              ...
              <option value="{{ $state->id }}" {{ $paper->state_id == $state->id ? 'selected' : null }}>{{
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="city" name="city_id">
              ...
              <option value="{{ $city->id }}" {{ $paper->city_id == $city->id ? 'selected' : null }}>{{ $city->city_name
                }}</option>
              @endforeach
              @endif
            </select>
