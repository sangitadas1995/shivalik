@extends('layouts.app')
@section('title','Edit Paper Vendor')
@push('extra_css')
...
<div class="page-name">
    <div class="row justify-content-between align-items-center">
        <div class="col-md-4">
        <h2>
          <a href="{{ route('paper-vendor') }}"><i class="ri-arrow-left-line"></i></a> Edit Paper Vendor</h2>
        </div>
    </div>
</div>
  <div class="card add-new-location mt-2">
    <div class="card-body">
      <form action="{{ route('vendors.paper.update', request()->id) }}" method="POST" id="vendor-add-form">
        @csrf
        <div class="row">
            <div class="col-md-12">
                @include('utils.alert')
            ...
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <input type="radio" id="paper_vendor" name="vendor_type_id" value="1" class="vendor_type" {{ $paper->vendor_type_id == 1 ? 'checked' : null }} />
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="company_name" id="company_name" value="{{ $paper->company_name }}" />
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="contact_person" id="contact_person" value="{{ $paper->contact_person }}" />
            ...
            <div class=" row">
              <div class="col-md-6">
                <div class="mb-3  d-flex flex-column">
                  ...
                  <input type="tel" id="mobile_code-1" class="form-control mobileNumber" name="mobile_no" value="{{ $paper->mobile_no }}" />
              ...
              <div class="col-md-6">
                <div class="mb-3 d-flex flex-column">
                  <label class="form-label">Alternative Mobile No.
                    :</label>
                  <input type="tel" id="mobile_code-2" class="form-control mobileNumber" name="alter_mobile_no" value="{{ $paper->alter_mobile_no }}" />
            ...
            <div class=" row">
              <div class="col-md-6">
                <div class="mb-3  d-flex flex-column">
                  ...
                  <input type="text" id="email" class="form-control" name ="email" value="{{ $paper->email }}" />
              ...
              <div class="col-md-6">
                <div class="mb-3 d-flex flex-column">
                  ...
                  <input type="text" id="alternative_email_id" class="form-control" name="alternative_email_id" value="{{ $paper->alternative_email_id }}" />
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="address" id="address" value="{{ $paper->address }}" />
        ...
        <div class="row">
              ...
              <select class="form-select" aria-label="Default select example" id="state" name="state_id">
                ...
                @if ($states->isNotEmpty())
                  @foreach ($states as $state)
                      <option value="{{ $state->id }}" {{ $paper->state_id == $state->id ? 'selected' : null }}>{{ $state->state_name }}</option>
                  @endforeach
                @endif
              </select>
              ...
              <select class="form-select" aria-label="Default select example" id="city" name="city_id">
                ...
                @if ($cities->isNotEmpty())
                  @foreach ($cities as $city)
                      <option value="{{ $city->id }}" {{ $paper->city_id == $city->id ? 'selected' : null }}>{{ $city->city_name }}</option>
                  @endforeach
                @endif
              </select>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="pincode" id="pincode" value="{{ $paper->pincode }}" />
