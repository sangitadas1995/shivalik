...
@section('content')
    <div class="page-name">
        <div class="row justify-content-between align-items-center">
            <div class="col-md-4">
                <h2>
                    <a href="{{ route('paper-vendor') }}"><i class="ri-arrow-left-line"></i></a> Edit Paper Vendor
                </h2>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="radio" id="paper_vendor" name="vendor_type_id" value="1" class="vendor_type"
                                {{ $paper->vendor_type_id == 1 ? 'checked' : null }} />
                        ...
                        <div class=" row">
                            <div class="col-md-6">
                                <div class="mb-3  d-flex flex-column">
                                    ...
                                    <input type="tel" id="mobile_code-1" class="form-control mobileNumber"
                                        name="mobile_no" value="{{ $paper->mobile_no }}" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 d-flex flex-column">
                                    <label class="form-label">Alternative Mobile No.
                                        :</label>
                                    <input type="tel" id="mobile_code-2" class="form-control mobileNumber"
                                        name="alter_mobile_no" value="{{ $paper->alter_mobile_no }}" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 d-flex flex-column">
                                    ...
                                    <input type="text" id="alternative_email_id" class="form-control"
                                        name="alternative_email_id" value="{{ $paper->alternative_email_id }}" />
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3  d-flex flex-column">
                                    ...
                                    <input type="tel" id="mobile_code-3" class="form-control onlyNumber phoneNumber"
                                        name="phone_no" value="{{ $paper->phone_no }}" />
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 d-flex flex-column">
                                    ...
                                    <input type="tel" id="mobile_code-4" class="form-control onlyNumber phoneNumber"
                                        name="alternative_phone_no" value="{{ $paper->alternative_phone_no }}" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control alphaNumericChar uppercaseChar"
                                        name="gst_no" id="gst_no" value="{{ $paper->gst_no }}" />
                                ...
                                @if ($states->isNotEmpty())
                                    @foreach ($states as $state)
                                        <option value="{{ $state->id }}"
                                            {{ $paper->state_id == $state->id ? 'selected' : null }}>
                                ...
                                @if ($cities->isNotEmpty())
                                    @foreach ($cities as $city)
                                        <option value="{{ $city->id }}"
                                            {{ $paper->city_id == $city->id ? 'selected' : null }}>{{ $city->city_name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var tot = {{ count($service_types) }};
            var counter = $(".product_list").length;
            var count = 0;
            ...
            $(document).on('change', '.vendor_type', function() {
                ...
                if (vendor_type) {
                    $.ajax({
                        ...
                        beforeSend: function() {
                            $('select#service_type_id').find("option:eq(0)").html(
                                "Please wait..");
                        },
                        success: function(response) {
                            console.log(response)
