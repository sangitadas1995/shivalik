                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;width:30%;">
                                                    <a href="JavaScript:void(0)" class="text-primary edit_po_creation" title="Edit Vendor PO" data-id ="{{ $po['id'] }}"><img src="{{asset('images/akar-icons_edit.png')}}" /></a>&nbsp;&nbsp;<a href="{{route('vendors.vendor-po-preview', encrypt($po['id']))}}" class="text-primary" target="__blank" title="View Vendor PO"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;<a href="{{route('vendors.po-download-invoice', encrypt($po['id']))}}" class="text-primary" target="__blank" title="Download Vendor PO"><i class="fa fa-file-pdf" aria-hidden="true"></i></a>&nbsp;&nbsp;
