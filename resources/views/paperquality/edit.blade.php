...
<div class="page-name">
  <div class="row justify-content-between align-items-center">
    <div class="col-md-4">
      <h2>
        <a href="{{ route('settings.papersettings.paper_quality_list') }}"><i class="ri-arrow-left-line"></i></a> Edit Paper Quality
      </h2>
    </div>
  </div>
</div>
<div class="card add-new-location mt-2">
  <div class="card-body">
    <form action="{{ route('settings.papersettings.updatepaperquality', encrypt($paperquality->id)) }}" method="POST" id="paperquality-edit-form">
      @csrf
      <div class="row">
        <div class="col-md-12">
          @include('utils.alert')
        ...
        <div class="col-md-12">
          <div class="mb-3">
            ...
            <input type="text" class="form-control alphaChar" name="quality_name" id="name" value="{{ $paperquality->name }}" />
